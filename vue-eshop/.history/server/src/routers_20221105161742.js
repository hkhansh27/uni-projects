...
module.exports = (app) => {
  ...
  app.post("/productDetails", ProductController.findOneById);

  app.post("/cart", ProductController.findAllByArrayId);
  ...
  app.get("/user/product", UserProductController.findAll);

  app.get("/user/order", AuthorizationController.verifyToken, UserOrderController.findAll);

  app.post("/user/order", AuthorizationController.verifyToken, UserOrderController.create);

  app.get("/user/orderDetails", AuthorizationController.verifyToken, UserOrderDetailsController.findOneById);
